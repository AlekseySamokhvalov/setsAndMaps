...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<String> strings = new ArrayList<>(List.of("привет", "ПРИВЕТ", "мир", "как", "привет", "лет", "лет", "ты"));
        task3(strings);
    ...
    public static void task3(List<String> strings) {
        ...
        System.out.println("Уникальные слова из списка слов, в котором могут встречаться дубли");
